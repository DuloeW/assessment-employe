...
import org.acme.exception.FormatException;
...
public class FormatUtil {
  ...
  public static LocalDateTime convertToLocalDate(String date) {
    try {
      ...
      throw new FormatException(
        "Format tanggal harus d-MM-yyy HH:mm:ss. Contoh : 29-08-2002 12:10:00"
      );
    }
  }
   ...
   * @return
   */
  public static Date plusDateTime(
    Date startTime,
    long duration,
    ChronoUnit unit
  ) {
   ...
   * @return
   */
  public static Date minusDateTime(
    Date startTime,
    long duration,
    ChronoUnit unit
  ) {
